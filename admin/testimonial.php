    ...
    <div class="col-md-10 column">
      <form class="form-horizontal" role="form" onsubmit="return false;">
        <div class="form-group">
          ...
          <div class="col-sm-4" >
          <textarea class="form-control textarea"  style="width:354px; height:139px;" rows="2" id="testimonial"></textarea>
          </div>
        </div>
      </form>
    </div>
...
<!--             <input type="text" class="form-control" id="logo" /> -->
        ...
        <input type="file" id="image" name="image" data-url="../api/testimonial_upload" class="file-pos">
